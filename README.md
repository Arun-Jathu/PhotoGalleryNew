\# Photo Gallery AppThe Photo Gallery App is a modern, responsive web application built with React and Redux, designed to display and manage a collection of photos. It fetches photo data from the JSONPlaceholder API (5000 photos) and allows users to browse photos in a grid view, view detailed information about each photo, and add/edit descriptions. The app features a sleek dark theme with teal accents, consistent design across all interfaces, and a focus on usability and accessibility. This project was developed as part of the application for the Frontend Developer position at GrayCorp.## Live DemoYou can view the live version of the Photo Gallery App here:\[https://jathuphotogalleryapp.netlify.app/\](https://jathuphotogalleryapp.netlify.app/)## Setup InstructionsFollow these steps to set up and run the Photo Gallery App locally on your machine.### Prerequisites- \*\*Node.js\*\*: Version 14.x or higher (recommended: 18.x). You can download it from \[nodejs.org\](https://nodejs.org/).- \*\*npm\*\*: Version 6.x or higher (comes with Node.js). Alternatively, you can use Yarn if preferred.- \*\*Git\*\*: Required to clone the repository. Install it from \[git-scm.com\](https://git-scm.com/).### Installation1. \*\*Clone the Repository\*\*: \`\`\`bash git clone https://github.com/your-username/PhotoGalleryNew.git cd PhotoGalleryNew

Replace your-username with your GitHub username.

1.  **Install Dependencies**:bashCollapseWrapCopynpm installThis will install all required packages listed in package.json.
2.  **Run the App**:bashCollapseWrapCopynpm run devThe app will start in development mode and open in your default browser at http://localhost:5173 (or another port if 5173 is in use).

### Build for Production

To create a production-ready build:

bashCollapseWrapCopynpm run build
...
- **Photo Grid View**: Browse photos in a responsive grid layout with search and pagination functionality (8 photos per page). Each card includes a "View Details" button for easy navigation to the photo’s details page. Fetches all 5000 photos available from the JSONPlaceholder API.
...
textCollapseWrapCopyPhotoGalleryNew/├── public/ # Static assets (e.g., favicon, index.html)├── src/ # Source code│ ├── components/ # React components│ │ ├── Gallery.jsx # Gallery page component with photo grid and pagination│ │ └── PhotoDetails.jsx # Photo Details page component with photo metadata│ ├── features/ # Redux slices│ │ └── photosSlice.js # Redux slice for fetching and managing photo data│ ├── App.jsx # Main app component with routing and header│ ├── App.css # Global styles (Tailwind CSS)│ ├── main.jsx # Entry point for the React app│ └── store.js # Redux store configuration├── screenshots/ # Screenshots for the README├── README.md # Project documentation└── package.json # Dependencies and scripts
...
The Photo Gallery App uses **Redux Toolkit** for state management. Redux Toolkit simplifies the process of managing global state in the application by providing a set of utilities to handle common Redux patterns. In this app:
...
[https://github.com/your-username/PhotoGalleryNew](https://github.com/your-username/PhotoGalleryNew)
...
**Submitted to**: [careers@graycorp.io](mailto:careers@graycorp.io)
